...
package com.ttrm.ttconnection.view.citywheel;
...
import com.ttrm.ttconnection.view.citywheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	private void drawCenterRect(Canvas canvas) {
		...
		paint.setColor(getResources().getColor(R.color.line_dividler));
		// 设置线宽
